...
{
  // Uncomment the two lines of code below to create a container ArrayList<E>dow for your turtles --#1
  ...
  private void showSomeTurtles()
  {
    ...
    int turtleNumber = turtles.size();
    // Uncomment to Show the number of turtles in the container on the window --#3.2
    new Text("There are " + turtleNumber + " turtles in the turtle container").setTopLeft(50, 50)
